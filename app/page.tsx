...
export default function Home() {
  ...
  if (isDesktop) {
    return (
      <DesktopShell>
        <header className="bg-white/92 backdrop-blur-xl backdrop-saturate-150 flex shrink-0 items-center gap-4 px-6 py-4 shadow-lg">
        ...
        {view === "quicklog" ? (
          <div className="flex flex-1 items-start justify-center overflow-y-auto p-5">
            <div className="bg-white/92 backdrop-blur-xl backdrop-saturate-150 w-full max-w-md overflow-hidden rounded-3xl border border-white/60 shadow-xl">
              <QuickLogView />
            </div>
          </div>
        ) : (
  ...
  return (
    <AppShell>
      <div
        className="bg-white/92 backdrop-blur-xl backdrop-saturate-150 flex shrink-0 gap-1 border-b border-line px-3 pb-2"
      ...
      {view === "quicklog" ? (
        ...
        <>
          <header className="bg-white/92 backdrop-blur-xl backdrop-saturate-150 flex shrink-0 items-center justify-between border-b border-line px-4 py-3">
            <div className="flex items-center gap-1">
              <IconButton icon={History} label="History" onClick={() => setHistoryOpen(true)} />
              <span className="relative inline-flex">
                <IconButton
          ...
          {people.length === 0 ? (
            <div className="flex flex-1 flex-col items-center justify-center gap-4 px-8 text-center">
              <p className="bg-white/92 backdrop-blur-xl backdrop-saturate-150 rounded-2xl border border-white/60 px-5 py-3 text-base text-ink shadow-lg">
