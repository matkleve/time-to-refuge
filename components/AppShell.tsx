...
export function AppShell({ children }: { children: ReactNode }) {
  return (
    <div className="min-h-dvh bg-white md:flex md:items-center md:justify-center md:bg-linear-to-br md:from-flagblue-50 md:via-white md:to-saffron-50 md:p-8">
      <main className="relative mx-auto flex h-dvh w-full max-w-[448px] flex-col overflow-hidden bg-white md:h-[850px] md:max-h-[92vh] md:rounded-shell md:shadow-2xl">
        {children}
      </main>
    </div>
  );
