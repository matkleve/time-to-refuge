...
export function SwipeToAction({
  ...
  return (
    <div className={cn("relative overflow-hidden rounded-2xl", className)}>
      {!disabled && (
        <div
          className="absolute inset-0 flex items-center justify-end bg-danger-600 pr-6 text-sm font-semibold text-white"
      ...
      <div
        ...
        style={{
          ...
          transition: dragX === 0 ? "transform 200ms cubic-bezier(0.2, 0.8, 0.2, 1)" : "none",
        }}
      >
        {children}
      </div>
