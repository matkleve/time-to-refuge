...
export function QuickLogView() {
  ...
  return (
    ...
    <div className="no-select flex flex-1 cursor-pointer flex-col overflow-hidden" onClick={handleLog}>
      <div className="bg-white/92 backdrop-blur-xl backdrop-saturate-150 border-b border-line px-3 py-2">
      ...
      <div className="flex flex-1 flex-col-reverse gap-2 overflow-y-auto px-4 py-3">
        {sorted.length === 0 ? (
          <p className="bg-white/92 backdrop-blur-xl backdrop-saturate-150 mx-auto rounded-2xl border border-white/60 px-4 py-2 text-center text-sm text-subtle shadow-sm">
