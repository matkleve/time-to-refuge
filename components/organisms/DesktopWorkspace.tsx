...
export function DesktopWorkspace({
  ...
  return (
    <div className="flex flex-1 gap-5 overflow-hidden p-5">
      ...
      <div className="flex w-80 shrink-0 flex-col overflow-hidden rounded-3xl bg-white/85 shadow-xl backdrop-blur-xl">
      ...
      <div className="flex flex-1 flex-col items-center overflow-y-auto py-2">
        {current ? (
          ...
          <p className="mt-20 rounded-2xl bg-white/85 px-6 py-4 text-center text-base text-ink shadow-lg backdrop-blur-xl">
            {people.length === 0
