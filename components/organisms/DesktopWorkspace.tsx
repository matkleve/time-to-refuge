...
export function DesktopWorkspace({
  ...
  return (
    <div className="flex flex-1 gap-5 overflow-hidden p-5">
      ...
      <div className="glass flex w-80 shrink-0 flex-col overflow-hidden rounded-3xl border border-white/60 shadow-xl">
      ...
      <div className="flex flex-1 flex-col items-center overflow-y-auto py-2">
        {current ? (
          ...
          <p className="glass mt-20 rounded-2xl border border-white/60 px-6 py-4 text-center text-base text-ink shadow-lg">
            {people.length === 0
